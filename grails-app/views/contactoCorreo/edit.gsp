...
<html>
	...
	<body>
		<a href="#edit-contactoCorreo" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-contactoCorreo" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${contactoCorreoInstance?.version}" />
				<fieldset class="form">
